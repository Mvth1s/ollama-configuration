...
A thin [Tauri](https://tauri.app) GUI wrapping `setup.sh`/`setup.ps1` (same options, streams the scripts' output live) is available in [`gui/`](gui/README.md), for the one-off install.
